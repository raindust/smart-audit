...
use smart_audit_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	smart_audit_runtime::api::dispatch,
	smart_audit_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			smart_audit_runtime::opaque::Block,
			smart_audit_runtime::RuntimeApi,
